/obj/item/gun/ballistic/shotgun/scp
	...
	icon = 'modular_scpse/modules/scp_weapons/icons/shotguns40x32.dmi'
	...
	fire_sound = 'modular_scpse/modules/scp_weapons/sound/shotgun_shot.ogg'
...
/obj/item/gun/ballistic/shotgun/scp/doublebarrel/attack_self(mob/living/user)
	if(!opened)
		playsound(src, 'modular_scpse/modules/scp_weapons/sound/doublebarrel_open.ogg')
		icon_state = "[base_icon_state]_open"
		opened = TRUE
	else
		playsound(src, 'modular_scpse/modules/scp_weapons/sound/doublebarrel_close.ogg')
...
/obj/item/gun/ballistic/shotgun/scp/spas12
	...
	semi_auto = TRUE
	load_sound = 'modular_scpse/modules/scp_weapons/sound/spas12/spas12_insert.ogg'
...
/obj/item/gun/ballistic/shotgun/scp/saiga12
	...
	semi_auto = TRUE
	fire_sound = 'modular_scpse/modules/scp_weapons/sound/saiga/saiga_shot.ogg'
